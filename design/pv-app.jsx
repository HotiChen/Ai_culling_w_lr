...
function App() {
  ...
  const [profileId, setProfileId] = React.useState('hotcha');
  ...
  const renderView = () => {
    switch (view) {
      case 'learn': return <LearnView accent={accent} onDone={() => { setProfileId('hotcha'); setView('inspector'); }} />;
      case 'inspector': return <InspectorView profile={profile} accent={accent} />;
      case 'cull': return <CullView accent={accent} onDone={() => setView('review')} />;
  ...
  return (
    <div className="desktop">
      <div className="window">
        ...
        <div className="body">
          <Sidebar view={view} setView={setView} profileId={profileId} setProfileId={setProfileId} accent={accent} />
